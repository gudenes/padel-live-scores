// apps/ops/src/lib/player-suggestion-fields.ts
//
// Mirrored from the main app's src/lib/player-suggestion-fields.ts (rule 3 —
// admin app copies shared logic rather than cross-importing). Keep byte-
// compatible with the main app: it is the single source of truth for which
// player fields are user-suggestable and how raw input is cleaned.
