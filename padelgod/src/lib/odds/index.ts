// MIRROR of src/lib/odds/index.ts — keep byte-identical. Canonical copy is tested there.
...
import type { OddsInput, OddsResult, ScoreState, Confidence } from './types.js'
import { preMatchProb, fairOdds } from './prematch.js'
import { anchorPerPoint, pWinMatchFav } from './scoring.js'
