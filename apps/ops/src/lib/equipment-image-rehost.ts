// apps/ops/src/lib/equipment-image-rehost.ts
// Lifted verbatim from src/lib/equipment-image-rehost.ts — keep byte-identical.
...
//   - /api/internal/brands and /api/internal/rackets (server-side rehost on every write)
//   - /api/internal/upload-equipment-image (bucket bootstrap)
//
