...
const TIER_GRADIENT: Record<string, string> = {
  p1:     'linear-gradient(135deg, #6B46C1, #9333EA)',
  p2:     'linear-gradient(135deg, #6B46C1, #9333EA)',
  major:  'linear-gradient(135deg, #6B46C1, #9333EA)',
  finals: 'linear-gradient(135deg, #6B46C1, #9333EA)',
  gold:   'linear-gradient(135deg, #92750E, #EAB308)',
  bronze: 'linear-gradient(135deg, #92400E, #D97706)',
  rise:   'linear-gradient(135deg, #155E75, #06B6D4)',
  future: 'linear-gradient(135deg, #334155, #64748B)',
}

const TIER_PILL: Record<string, { background: string; color: string }> = {
  p1:     { background: 'linear-gradient(135deg, #6B46C1, #9333EA)', color: '#fff' },
  p2:     { background: 'linear-gradient(135deg, #6B46C1, #9333EA)', color: '#fff' },
  major:  { background: 'linear-gradient(135deg, #6B46C1, #9333EA)', color: '#fff' },
  finals: { background: 'linear-gradient(135deg, #6B46C1, #9333EA)', color: '#fff' },
  gold:   { background: 'linear-gradient(135deg, #92750E, #EAB308)', color: '#1A1A1A' },
  bronze: { background: 'linear-gradient(135deg, #92400E, #D97706)', color: '#fff' },
  rise:   { background: 'linear-gradient(135deg, #155E75, #06B6D4)', color: '#fff' },
  future: { background: 'linear-gradient(135deg, #334155, #64748B)', color: '#fff' },
}
