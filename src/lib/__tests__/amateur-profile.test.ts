...
const RAW: AmateurRawRows = {
  ...
  roster: [
    { player_id: PLAYER_ID,  roster_rank: 9, games_played: 7, wins: 2, losses: 5, is_captain: false, player: { id: PLAYER_ID,  name: 'Gustavo Denes',  avatar_url: null, country: null } },
    { player_id: 'p-abraham', roster_rank: 22, games_played: 0, wins: 0, losses: 0, is_captain: false, player: { id: 'p-abraham', name: 'Abraham Torres', avatar_url: null, country: null } },
  ],
  fixtures: [
