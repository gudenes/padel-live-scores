// apps/ops/src/app/api/internal/tournament-fip-twin/route.ts
//
// GET /api/internal/tournament-fip-twin?tournament_id=X
//
...
//
// Ported from src/app/api/ops/tournament-fip-twin/route.ts (Plan 3a hotfix).
