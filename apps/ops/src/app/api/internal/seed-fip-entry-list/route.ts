// apps/ops/src/app/api/internal/seed-fip-entry-list/route.ts
// POST /api/internal/seed-fip-entry-list — runs the FIP entry-list pipeline for a
...
//
// Ported from src/app/api/ops/seed-fip-entry-list/route.ts (Plan 3a hotfix).
