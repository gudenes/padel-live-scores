...
export function WhereToWatchPill({
  ...
  return (
    <>
      ...
      >
        {/* YouTube-style play-button glyph — borrowed for recognition value:
            the popup's primary content is YT live broadcasts, and a red play
            rectangle reads as "watch a video stream" universally. */}
        <span style={{
