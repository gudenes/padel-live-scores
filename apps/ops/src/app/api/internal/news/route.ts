// apps/ops/src/app/api/internal/news/route.ts
// List + create news posts. Auth: Auth.js session (isOperator).
...
export async function POST(req: Request) {
  ...
  if (status === 'published') {
    try {
      ...
      console.error('[POST /api/internal/news] Translation failed (post still published):', (e as Error).message)
    }
  }
