// apps/ops/src/components/ShadowMatchCard.tsx
// Presentational card for a shadow-captured match. Mirrors MatchCard's look
// but reads from LiveCard (shadow-derived) data. Yellow dot marks the serving team.

import type { LiveCard, PlayerLite, Side } from '@/lib/padelgod-live-cards'

// Yellow dot instead of a tennis ball emoji — emoji rendering varies by device.
