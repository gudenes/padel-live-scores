// apps/ops/src/app/api/internal/padelgod-health/route.ts
//
// GET /api/internal/padelgod-health
//
...
export async function GET() {
  ...
  const [
    ...
    runCount(supabase, since24h, { jobType: 'discover', tournamentIdIsNull: true }),
    runCount(supabase, since24h, { jobType: 'widget_id' }),
    runCount(supabase, since24h, { jobType: 'discover', urlLike: '%entrylist%' }),
    runCount(supabase, since24h, { jobType: 'oop', urlNotLike: '%resultsbyday%' }),
    runCount(supabase, since24h, { jobType: 'oop', urlLike: '%resultsbyday%' }),
    runCount(supabase, since24h, { jobType: 'draw' }),
